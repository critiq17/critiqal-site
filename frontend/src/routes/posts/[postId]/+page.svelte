...
<div class="min-h-screen bg-gray-50">
  ...
  <nav class="nav">
    <div class="nav-container">
      ...
      <!-- User Menu -->
      <div class="relative">
        <button onclick={() => (menuOpen = !menuOpen)} class="avatar-btn">
          {#if user.photo_url}
        ...
        {#if menuOpen}
          <div class="dropdown-menu" transition:fly={{ y: 10, duration: 150 }}>
            <button onclick={() => goto('/profile')} class="menu-item">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
              Profile
            </button>
            <button onclick={() => goto('/settings')} class="menu-item">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button onclick={logout} class="menu-item-danger">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="content-container">
    <!-- Back Button -->
    <button onclick={goBack} class="back-btn" in:fly={{ x: -12, duration: 400, easing: cubicOut }}>
